...
function Home() {
    ...
    const stats = [
        { title: "Employees", value: employeeCount, icon: <PeopleIcon sx={{ fontSize: 50 }} />, color: "#A242EBFF" },
        { title: "Departments", value: departmentCount, icon: <ApartmentIcon sx={{ fontSize: 50 }} />, color: "#7D39D6FF" },
        { title: "Pending Leaves", value: pendingLeaves, icon: <AccessTimeIcon sx={{ fontSize: 50 }} />, color: "#682188FF" },
        { title: "Payroll", value: payroll ? `₺${Number(payroll).toLocaleString()}` : "₺0", icon: <AttachMoneyIcon sx={{ fontSize: 50 }} />, color: "#360E56FF" },
    ];
